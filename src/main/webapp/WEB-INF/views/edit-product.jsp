...
<html>
<head>
    <title>Edit Product - HomeCraft</title>
    ...
    <style>
        ...
        .hc-current-image img{
            width: 90px; height: 90px;
            object-fit: cover;
            border-radius: 12px;
            box-shadow: 0 10px 22px rgba(58,52,46,.15);
        }
        .hc-current-image .hc-current-label{
            font-size: .78rem;
            font-weight: 600;
            letter-spacing: .6px;
            text-transform: uppercase;
...
<body>
    ...
    <div class="hc-form-wrap">
        <div class="hc-form-card">
            ...
            <h1>Edit Product</h1>
            <p class="hc-sub">Update the details for this HomeCraft product.</p>
            ...
            <form action="/products/edit/${product.id}" method="post" enctype="multipart/form-data">
                ...
                <div class="hc-current-image">
                    <img src="${product.imagePath}" alt="${product.name}">
                    <span class="hc-current-label">Current Image</span>
                </div>

                <div class="hc-field">
                    <label for="imageFile">Upload New Image</label>
                    <input type="file" id="imageFile" name="imageFile">
                    <small>Leave empty if you do not want to change the image.</small>
                </div>

                <button type="submit" class="hc-btn-submit">Update Product</button>
            </form>

            <a href="/products" class="hc-back-link">&larr; Cancel</a>
        </div>
    </div>
